...
def main():
    ...
    model = LinClassifier("/home/kashankarimudin/asmaa_google_pt/cifar_resnet_epoch89_bs64_ns40_cs8_hs100_g3.pt").to(device)
    ...
    tsne.fit(X,y)
    tsne.finalize()
    plt.savefig(f"cifar10_vs_cifar100_dt{data_points}.png")
    # tsne.show()
